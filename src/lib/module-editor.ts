...
- Se o problema for humanização, adicione ponte humana curta após dor/objetivo do paciente: validar ponto específico + conectar com avaliação + próximo passo. Proíba travessão longo nas mensagens finais.
- Se o problema for resposta fora de escopo, proíba responder o conteúdo, mesmo se for uma pergunta simples. A correção deve redirecionar para clínica, tratamentos ou agendamento em 1 frase.
