...
- Se o problema mostrar tom robótico, adicione ponte humana curta após dor/objetivo do paciente e proíba travessão longo nas mensagens finais.
- Se o problema mostrar resposta fora de escopo, proíba responder o conteúdo, mesmo se for uma pergunta simples; redirecione para clínica, tratamentos ou agendamento em 1 frase.
